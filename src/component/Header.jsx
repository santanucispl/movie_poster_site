  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link" href="#" to='Shop'>Shop</Link>
        </li>
      ...
      <Link className="btn-dark btn " to='Cart'><BsFillBox2HeartFill/></Link>
      <Link className="btn-dark btn " to='Cart'><BsFillCartFill/>{cartItem.length}</Link>
    </div>
  </div>
</nav>
        </>
